...
// was not loaded in eager-loading.
func (e PlayerEdges) EventsOrErr() ([]*Event, error) {
	if e.loadedTypes[1] {
		return e.Events, nil
	}
...
func (*Player) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case player.FieldID, player.FieldGlobal:
...
func (pl *Player) QueryEvents() *EventQuery {
	return NewPlayerClient(pl.config).QueryEvents(pl)
}
...
func (pl *Player) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", pl.Global))
	builder.WriteString(", ")
