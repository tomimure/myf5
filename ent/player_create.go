...
func (pc *PlayerCreate) SetGlobal(i int) *PlayerCreate {
	pc.mutation.SetGlobal(i)
	return pc
}
...
func (pc *PlayerCreate) AddEventIDs(ids ...int) *PlayerCreate {
	pc.mutation.AddEventIDs(ids...)
	return pc
}

// AddEvents adds the "events" edges to the Event entity.
func (pc *PlayerCreate) AddEvents(e ...*Event) *PlayerCreate {
	ids := make([]int, len(e))
	for i := range e {
		ids[i] = e[i].ID
	}
...
func (pc *PlayerCreate) check() error {
	if _, ok := pc.mutation.Global(); !ok {
		return &ValidationError{Name: "global", err: errors.New(`ent: missing required field "Player.global"`)}
	}
...
func (pc *PlayerCreate) createSpec() (*Player, *sqlgraph.CreateSpec) {
	...
	if value, ok := pc.mutation.Global(); ok {
